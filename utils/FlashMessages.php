...
class FlashMessages
{
    ...
    protected $msgWrapper = "<div class='container mt-3'>
                                <div class='card %s z-depth-2'>
                                            <div>
    ...
    protected $cssClassMap = [
        self::INFO => 'info-color',
        self::SUCCESS => 'primary-color',
        self::WARNING => 'warning-color-dark',
        self::ERROR => 'red lighten-1',
    ];
